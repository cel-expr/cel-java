...
public final class RawProtoMessageLiteValueTest {
  ...
  @Test
  public void selectField_presentOnWire_decoded() throws Exception {
    ByteArrayOutputStream baos = new ByteArrayOutputStream();
    CodedOutputStream cos = CodedOutputStream.newInstance(baos);
    ...
    Object val = raw.selectField(SelectField.create(14L, "single_string", 9, ""));

    assertThat(val).isEqualTo("hello");
  }

  @Test
  public void selectField_absentWithDefaultValue_returnsDefault() {
    RawProtoMessageLiteValue raw =
        RawProtoMessageLiteValue.create(
            ByteString.EMPTY, "cel.expr.conformance.proto3.TestAllTypes");

    Object val = raw.selectField(SelectField.create(14L, "single_string", 9, "default"));

    assertThat(val).isEqualTo("default");
  }

  @Test
  public void selectField_withConverter_resolvesDescriptor() {
    RawProtoMessageLiteValue raw =
        RawProtoMessageLiteValue.create(
            ByteString.EMPTY, "cel.expr.conformance.proto3.TestAllTypes", CONVERTER);

    Object val = raw.selectField(SelectField.create(14L, "single_string"));

    assertThat(val).isEqualTo("");
  }

  @Test
  public void hasField_wirePresent_returnsTrue() throws Exception {
    ByteArrayOutputStream baos = new ByteArrayOutputStream();
    CodedOutputStream cos = CodedOutputStream.newInstance(baos);
    cos.writeString(14, "present");
    cos.flush();
    RawProtoMessageLiteValue raw =
        RawProtoMessageLiteValue.create(
            ByteString.copyFrom(baos.toByteArray()), "cel.expr.conformance.proto3.TestAllTypes");

    assertThat(raw.hasField(SelectField.create(14L, "single_string"))).isTrue();
  }

  @Test
  public void hasField_wireAbsent_returnsFalse() {
    RawProtoMessageLiteValue raw =
        RawProtoMessageLiteValue.create(
            ByteString.EMPTY, "cel.expr.conformance.proto3.TestAllTypes");

    assertThat(raw.hasField(SelectField.create(15L, "other_field"))).isFalse();
  }

  @Test
  public void hasField_emptyPackedRepeated_withDescriptor_returnsFalse() throws Exception {
    ByteArrayOutputStream baos = new ByteArrayOutputStream();
    CodedOutputStream cos = CodedOutputStream.newInstance(baos);
    ...
    assertThat(raw.hasField(SelectField.create(31L, "repeated_int32"))).isFalse();
  }
  ...
  public void hasField_emptyPackedRepeated_withoutDescriptor_returnsFalse() throws Exception {
    ...
    assertThat(raw.hasField(SelectField.create(31L, "repeated_int32", 5, ImmutableList.of())))
        .isFalse();
  }

  @Test
  public void hasField_nonEmptyPackedRepeated_returnsTrue() throws Exception {
    ByteArrayOutputStream baos = new ByteArrayOutputStream();
    CodedOutputStream cos = CodedOutputStream.newInstance(baos);
    ...
    packedCos.flush();
    cos.writeBytes(31, ByteString.copyFrom(packed.toByteArray()));
    cos.flush();
    RawProtoMessageLiteValue raw =
        RawProtoMessageLiteValue.create(
            ByteString.copyFrom(baos.toByteArray()),
    ...
    assertThat(raw.hasField(SelectField.create(31L, "repeated_int32"))).isTrue();
  }

  @Test
  public void navigateField_intermediatePresentAndAbsent() throws Exception {
    ...
    ByteArrayOutputStream baos = new ByteArrayOutputStream();
    CodedOutputStream cos = CodedOutputStream.newInstance(baos);
    cos.writeBytes(21, ByteString.copyFrom(subBaos.toByteArray()));
    cos.flush();
    RawProtoMessageLiteValue raw =
        RawProtoMessageLiteValue.create(
            ByteString.copyFrom(baos.toByteArray()), "cel.expr.conformance.proto3.TestAllTypes");

    Object nav = raw.navigateField(SelectField.create(21L, "single_nested_message"));

    assertThat(nav).isInstanceOf(RawProtoMessageLiteValue.class);
    assertThat(raw.navigateField(SelectField.create(999L, "absent"))).isNull();
  }

  @Test
  public void selectField_mapFieldWithDescriptor_decodesEntries() {
    TestAllTypes proto =
    ...
    Object selected =
        raw.selectField(SelectField.create(61L, "map_string_string", -1, ImmutableMap.of()));

    assertThat(selected).isEqualTo(ImmutableMap.of("k1", "v1", "k2", "v2"));
  }

  @Test
  public void selectField_wellKnownDuration_convertsToJavaDuration() {
    TestAllTypes proto =
        TestAllTypes.newBuilder()
    ...
    Object selected =
        raw.selectField(SelectField.create(101L, "single_duration", 11, Duration.ZERO));

    assertThat(selected).isEqualTo(Duration.ofSeconds(10L, 500L));
  }

  @Test
  public void selectField_wellKnownInt64Wrapper_convertsToLong() {
    TestAllTypes proto =
        TestAllTypes.newBuilder().setSingleInt64Wrapper(Int64Value.of(12345L)).build();
    RawProtoMessageLiteValue raw =
        RawProtoMessageLiteValue.create(
            proto.toByteString(), "cel.expr.conformance.proto3.TestAllTypes", CONVERTER);
    ...
    assertThat(selected).isEqualTo(12345L);
  }

  @Test
  public void navigateField_scalarFieldWithDescriptor_returnsScalar() {
    TestAllTypes proto = TestAllTypes.newBuilder().setSingleInt64(99L).build();
    RawProtoMessageLiteValue raw =
        RawProtoMessageLiteValue.create(
            proto.toByteString(), "cel.expr.conformance.proto3.TestAllTypes", CONVERTER);

    Object nav = raw.navigateField(SelectField.create(2L, "single_int64"));

    assertThat(nav).isEqualTo(99L);
  }

  @Test
  public void navigateField_scalarFieldWithoutDescriptor_returnsScalar() {
    TestAllTypes proto = TestAllTypes.newBuilder().setSingleInt64(99L).build();
    RawProtoMessageLiteValue raw =
        RawProtoMessageLiteValue.create(
            proto.toByteString(), "cel.expr.conformance.proto3.TestAllTypes");
