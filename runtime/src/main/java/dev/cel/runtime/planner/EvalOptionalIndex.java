...
@Immutable
final class EvalOptionalIndex extends PlannedInterpretable {
  ...
  static EvalOptionalIndex create(
      CelExpr expr,
      String functionName,
    ...
    return new EvalOptionalIndex(
        expr, functionName, resolvedOverload, target, index, celValueConverter);
  }

  private EvalOptionalIndex(
      CelExpr expr,
      String functionName,
      CelResolvedOverload resolvedOverload,
      PlannedInterpretable target,
