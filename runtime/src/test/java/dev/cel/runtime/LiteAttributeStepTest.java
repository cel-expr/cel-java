...
public final class LiteAttributeStepTest {
  ...
  public void qualifyAttribute_protoMessageLite_knownMapField() {
    ...
    Object result =
        LiteAttributeStep.qualifyAttribute(
            message,
            ImmutableList.of(ImmutableList.of(61, "map_string_string", 20, ImmutableMap.of())),
            CONVERTER);
  ...
  public void qualifyAttribute_protoMessageLite_knownUnsetSubmessage_returnsDefaultInstance() {
    ...
    assertThat(result).isInstanceOf(TestAllTypes.NestedMessage.class);
    assertThat(result).isEqualTo(TestAllTypes.NestedMessage.getDefaultInstance());
  }

  @Test
  public void qualifyAttribute_protoMessageLite_unknownSubmessage_hasProtoTypeName()
      throws Exception {
    ...
    assertThat(nested.celType().name()).isEqualTo("unknown_submessage");
  }
