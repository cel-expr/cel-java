...
public final class OptimizedSelectPlannerTest {
  ...
  private enum InvalidSelectAstTestCase {
    ...
    WRAPPER_TYPE_IDENT(
        ...
        "Leaf well-known type 'google.protobuf.Int64Value' is not supported"),
    ANY_TYPE_IDENT(
        "cel.@attribute(msg, [[100, 'single_any', 11]], google.protobuf.Any)",
        "Leaf well-known type 'google.protobuf.Any' is not supported"),
