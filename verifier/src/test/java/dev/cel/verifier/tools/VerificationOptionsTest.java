...
public final class VerificationOptionsTest {
  ...
  public void parseCelType_optionalTypes() {
    ...
    assertThat(VerificationOptions.parseCelType("optional(double)"))
        .isEqualTo(OptionalType.create(SimpleType.DOUBLE));
    assertThat(VerificationOptions.parseCelType("optional_type<bool>"))
        .isEqualTo(OptionalType.create(SimpleType.BOOL));
    assertThat(VerificationOptions.parseCelType("optional_type(bytes)"))
        .isEqualTo(OptionalType.create(SimpleType.BYTES));
