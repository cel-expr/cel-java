...
public final class CelVerifierToolCore {

  private CelVerifierToolCore() {}

  /** Checks if a single CEL expression is satisfiable. */
  public static CelVerificationResult checkSatisfiable(
  ...
  public static CelVerificationResult checkValid(
      String expression, Map<String, CelType> variables, VerificationOptions options)
      throws Exception {
    CelCompiler compiler = buildCompiler(variables);
    CelAbstractSyntaxTree ast = compiler.compile(expression).getAst();
  ...
  public static CelVerificationResult verifyEquivalence(
      String expressionA,
      String expressionB,
  ...
  public static ImmutableMap<String, CelVerificationResult> verifyPolicyInvariants(
  ...
  public static CelVerificationResult verifyPolicyEquivalence(
      String yamlContentA,
      String yamlContentB,
      Map<String, CelType> variables,
      VerificationOptions options)
  ...
  public static CelCompiler buildCompiler(Map<String, CelType> variables) {
  ...
  public static CelVerifier buildVerifier(VerificationOptions options) {
