...
/** Public interface for verifying CEL policies. */
public interface CelPolicyVerifier {

  /**
   * Verifies if two policies are strictly equivalent for all possible inputs.
   *
   * @throws CelPolicyValidationException if the provided policies fail policy-specific compilation.
   */
