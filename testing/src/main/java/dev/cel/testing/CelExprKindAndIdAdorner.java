...
public final class CelExprKindAndIdAdorner implements CelAdorner {
  ...
  static OneofDescriptor findOneofByName(Descriptor descriptor, String name) {
    ...
    throw new IllegalArgumentException(
        String.format("Oneof '%s' not found in descriptor '%s'", name, descriptor.getName()));
  }

  static String getContainedName(Descriptor descriptor) {
  ...
  static String getContainedName(EnumDescriptor descriptor) {
    Deque<String> parts = new ArrayDeque<>();
    parts.addFirst(descriptor.getName());
    Descriptor containing = descriptor.getContainingType();
    while (containing != null) {
